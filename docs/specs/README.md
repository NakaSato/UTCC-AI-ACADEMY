...
- [SPEC-0052 — Vue islands: the mount contract, the registry, and what an island may not do](spec-vue-islands.md) — accepted; render functions only, copy from the locale files, every island an enhancement over markup that already works, and upgrading Vue is two steps
