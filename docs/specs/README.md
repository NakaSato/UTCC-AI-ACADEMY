...
- [SPEC-0049 — The proposal request intake as built](spec-proposal-request-intake.md) — draft; records the shipped intake that had no governing document, including the dead statuses, so any change to proposals has a baseline
