...
- [ADR-0041 — Define a student-initiated internship request, placement, and progress boundary](adr-0041-student-internship-request-boundary.md) — draft; Product, Security, Privacy, Academic, Recruitment, and QA review pending, and human decision 1 decides whether the request layer is built at all
