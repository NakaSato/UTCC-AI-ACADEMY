...
- [ADR-0052 — Give a notification somewhere to be read after the ninth](adr-0052-notification-history.md) — proposed; the bell caps at eight and nothing reaches the ninth, and because production email is deferred the bell is the only channel. Five questions carry recommendations and none is accepted
