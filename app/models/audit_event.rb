...
class AuditEvent < ApplicationRecord
  ...
  ACTIONS = %w[
    ...
    role_changed account_suspended account_restored
    course_state_changed course_updated
    approval_decided lesson_addition_decided lesson_retirement_decided lesson_restoration_decided
    proposal_decided
  ...
  WARN = %w[ console_account_created console_password_reissued role_changed account_suspended account_restored course_state_changed approval_decided lesson_addition_decided lesson_retirement_decided lesson_restoration_decided proposal_decided feature_setting_changed lesson_integrity_setting_changed lesson_ai_policy_changed
